       ...
       <nav style="background-color: #122e57">
        <div style="display: flex; justify-content:space-between; align-items:center;" >
            ...
            <div>
                ...
                <ul  class="list-group list-group-flush" style="width:40%; margin: auto; margin-top:3%;  ">
                  ...
                  background: linear-gradient(0deg, rgba(76,81,191,0.9192051820728291) 11%, rgba(76,81,191,1) 33%); color:#e3e6e9; display:flex; justify-content:space-between;" class="list-group-item"><strong>{{$name}} </strong>
                      <div style="display: flex;" >
                       ...
                       <li style="background: #e0e9f3" class="list-group-item">{{$job->job_type}}</li>
             ...
             @endphp
              ...
              <div class="container" style="margin-top: 3%; width:30%" >
                <form method="post" action="{{ route('public_store.application', $job->id) }}"  id="myForm">
                  @csrf
