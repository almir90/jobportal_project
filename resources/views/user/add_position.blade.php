...
<div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <nav class="mt-10">
        ...
        <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25"
            href="{{ route('user.application_list') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" >
                <path fill="#ffff" d="M23 6H1c-.552 0-1-.448-1-1s.448-1 1-1h22c.553 0 1 .448 1 1s-.447 1-1 1zM23 13H1c-.552 0-1-.447-1-1s.448-1 1-1h22c.553 0 1 .447 1 1s-.447 1-1 1zM23 20H1c-.552 0-1-.447-1-1s.448-1 1-1h22c.553 0 1 .447 1 1s-.447 1-1 1z"/>
              </svg>
  ...
  <header>
    <h1><strong>Insert Job Details !</strong> </h1> <br><br>
  </header>
  
  
  <form method="post" action="{{ route('user.store_position') }}" id="myForm" >
    @csrf
    <div class="form-group">
      <label for="job_position">Job Position:</label>
      <input name="job_position" type="text" class="form-control" style="border:none" id="job_position" >
    </div>
    <div class="form-group">
      <label for="job_type">Job Type:</label>
      <input name="job_type" type="text" class="form-control" style="border:none" id="job_type" >
    </div>
    <div class="form-group">
      <label for="location">Location:</label>
      <input name="location" type="text" class="form-control" style="border:none" id="location" >
    </div>
    
    <div class="form-group">
      <label for="description">Job Description:</label>
      <textarea name="job_description" class="form-control" rows="5" id="job_description"></textarea>
    </div>
    
    <input type="submit" class="btn btn-dark waves-effect waves-light  " style="background: black" value="Add Position" >
