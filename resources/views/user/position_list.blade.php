...
<tbody>
    ...
    {{-- @php
        ...
        // $created_by = DB::table('jobs')->select('created_by')->get();
     @endphp --}}
...
<tr>
    ...
    <td >
        ...
        <a href="{{ route('user.edit_position', $job->id) }}" class="btn btn-info sm" title="Edit Data">  <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
       
            <a href="{{ route('user.delete_position', $job->id) }}" class="btn btn-danger sm" title="Delete Data" id="delete">  <i class="fa fa-trash-o" aria-hidden="true"></i></i></i> </a>
